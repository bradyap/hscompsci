...
public class TicTacToeLegacy {
    public static void main(String[] args) {
        ...
        while (choice.equals("y")) {
            TicTacToeLegacy.game(input, p1, p2);
    ...
    public static void game(Scanner input, String p1, String p2) {
        //makes board and fills it with -'s
        ...
        while(!gameOver) {
            ...
            if(player1) System.out.println(p1 + ", it is your turn. You are x's.");
            else System.out.println(p2 + ", it is your turn. You are o's.");
            while (true) {
                row = getRow(input);
                col = getCol(input);
                if(board[row][col] != '-') System.out.println("This space on the board is full. Please enter an empty space.");
                else break;
            }
